...
<template>
  <div>
    ...
    <UPageSection>
      <UPageCTA
        title="Ready to build your next Adonis app?"
        description="Join thousands of developers building with Adonis and Nuxt UI. Get this template and start shipping today."
        variant="subtle"
        :links="[{
